...
/**
 * 等额本金工具类 校验网址：http://www.xjumc.com/ 等额本金是指一种贷款的还款方式，是在还款期内把贷款数总额等分，每月偿还同等数额的本金和剩余贷款在该月所产生的利息，这样由于每月的还款本金额固定， * 而利息越来越少，借款人起初还款压力较大，但是随时间的推移每月还款数也越来越少。
 *
 * @author VectorX
 * @version 1.0.0
 * @date 2024/01/26
...
public class Amount2Helper
{
    ...
    public static Map<Integer, BigDecimal> getPerMonthInterest(BigDecimal invest, BigDecimal yearRate, int totalMonth) {
        ...
        for (Map.Entry<Integer, BigDecimal> entry : map.entrySet()) {
            BigDecimal principalInterestBigDecimal = new BigDecimal(entry
                    .getValue()
                    .toString());
